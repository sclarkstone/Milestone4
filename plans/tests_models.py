...
class TestModels(TestCase):
    ...
    def test_session_string_method(self):
        distance = Distance.objects.create(name="Test", friendly_name='test', duration=6, product_id=1, instructions='test')
        session = Session.objects.create(distance=distance, effort='test', description='test', week=1, day=1)
